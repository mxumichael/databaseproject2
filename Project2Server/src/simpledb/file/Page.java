...
public class Page {
	...
	public synchronized Short getShort(int offset) {
		contents.position(offset);
		Short byteval = contents.getShort();
		return byteval;
	}
	...
	/**
	 * Returns the Byte array at the specified offset of the page.
	 * If a Short was not stored at that location,
	 * the behavior of the method is unpredictable.
	 * @param offset the byte offset within the page
	 * @return the string value at that offset
	...
	/**
	 * Returns the Date at the specified offset of the page.
	 * If a Short was not stored at that location,
	 * the behavior of the method is unpredictable.
	 * @param offset the byte offset within the page
	 * @return the string value at that offset
	...
	public synchronized Date getDate(int offset) {
		...
		contents.get(byteval);
		try {
			//the following code compliments of http://laksmono.com/2009/08/06/how-to-convert-object-to-byte-array-and-vice-versa/
			ObjectInputStream ois = 
					new ObjectInputStream(new ByteArrayInputStream(byteval));
			Date dateobj = (Date) ois.readObject();
			ois.close();
			//end section from http://laksmono.com/2009/08/06/how-to-convert-object-to-byte-array-and-vice-versa/ 
